...
const Navbar = () => {
    ...
    return ( <>{showNavbar && <nav className='bg-white flex justify-between items-center fixed top-4 sm:top-6 lg:top-10 left-1/2 -translate-x-1/2 w-[92vw] md:w-[88vw] lg:w-[80vw] max-w-7xl rounded-full p-3 px-4 sm:p-4 sm:px-6 lg:p-5 lg:px-7 shadow-md z-50'>
            ...
            <div className='flex gap-2 sm:gap-3 items-center shrink-0'>
                <button className="login bg-gray-400 p-2 px-3 sm:p-3 sm:px-4 lg:p-4 rounded-lg font-bold text-xs sm:text-sm lg:text-base">Log in</button>
                <button className="signup bg-gray-900 text-white font-bold p-2 px-3 sm:p-3 sm:px-4 lg:p-4 rounded-full text-xs sm:text-sm lg:text-base whitespace-nowrap"> Sign up free</button>
            </div>
        </nav>}
        </>
